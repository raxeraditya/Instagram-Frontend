...
const SAMPLE_POSTS = [
  {
    ...
    postImage:
      "https://images.unsplash.com/photo-1707343843437-caacff5cfa74?w=1200&h=1200&fit=crop",
  ...
  },
  {
    ...
    postImage:
      "https://images.unsplash.com/photo-1707343844416-cce1797fd898?w=1200&h=1200&fit=crop",
  ...
  },
  {
    ...
    postImage:
      "https://images.unsplash.com/photo-1707343844459-2ab66b6f4d68?w=1200&h=1200&fit=crop",
...
export function HomePage() {
  return (
    <div className="max-w-[90%] mx-auto px-4 flex flex-col md:flex-row">
      {/* Main Feed */}
